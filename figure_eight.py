...
drone.sendControlWhile(0,54,0,0,2000)
drone.sendControlWhile(0,0,0,80,2000)
drone.sendControlWhile(0,40,0,0,2000)
drone.sendControlWhile(0,0,0,-55,1500)
drone.sendControlWhile(0,-62,0,0,1000)
drone.sendControlWhile(0,0,0,65,2000)
drone.sendControlWhile(0,-45,0,0,2000)
drone.sendControlWhile(0, 0, 0, -60, 2000)
drone.sendControlWhile(0, 50, 1, 0, 3000)
